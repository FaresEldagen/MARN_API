...
namespace MARN_API.Migrations
{
    ...
    [Migration("20260503084136_Adding-Payments-Models")]
    partial class AddingPaymentsModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MARN_API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AmountTotal = 5000m,
                            AvailableAt = new DateTime(2026, 4, 10, 8, 41, 33, 437, DateTimeKind.Utc).AddTicks(2940),
                            Currency = "egp",
                            OwnerAmount = 4500m,
                            PaidAt = new DateTime(2026, 4, 3, 8, 41, 33, 437, DateTimeKind.Utc).AddTicks(2938),
                            PaymentIntentId = "pi_seed_1",
                            PaymentScheduleId = 3L,
                            PlatformFee = 500m,
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("MARN_API.Models.PaymentSchedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContractId = 950001L,
                            Currency = "egp",
                            DueDate = new DateTime(2026, 5, 8, 8, 41, 33, 437, DateTimeKind.Utc).AddTicks(2657),
                            Status = 0
                        },
                        new
                        {
                            ...
                            ContractId = 950001L,
                            Currency = "egp",
                            DueDate = new DateTime(2026, 6, 3, 8, 41, 33, 437, DateTimeKind.Utc).AddTicks(2665),
                            Status = 0
                        },
                        new
                        {
                            ...
                            ContractId = 950001L,
                            Currency = "egp",
                            DueDate = new DateTime(2026, 4, 3, 8, 41, 33, 437, DateTimeKind.Utc).AddTicks(2671),
                            Status = 2
                        });
                });
            ...
            modelBuilder.Entity("MARN_API.Models.Payment", b =>
                {
                    ...
                    b.HasOne("MARN_API.Models.PaymentSchedule", "PaymentSchedule")
                        .WithOne("Payment")
                        .HasForeignKey("MARN_API.Models.Payment", "PaymentScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
