    ...
    public class PropertySeed : IEntityTypeConfiguration<Property>
    {
        public void Configure(EntityTypeBuilder<Property> builder)
        {
            ...
            builder.HasData(
                ...
                // Cairo
                new Property { Id = 2001, OwnerId = ownerXId, Title = "Nile View Apartment", Description = "A bright apartment near downtown Cairo for monthly stays", Type = PropertyType.Apartment, IsShared = false, MaxOccupants = 3, Bedrooms = 2, Beds = 3, Bathrooms = 1, SquareMeters = 118, Views = 14, Price = 7200m, RentalUnit = RentalUnit.Monthly, Address = "15 Tahrir Square", City = "Cairo", State = Governorate.CairoGovernorate.ToString(), ZipCode = "11511", Latitude = 30.0444, Longitude = 31.2357, IsActive = true, Status = PropertyStatus.Verified, CreatedAt = new DateTime(2026, 5, 1, 0, 0, 0, DateTimeKind.Utc), ProofOfOwnership = "/images/documents/property2001-POO.jpg" },
                ...
                new Property { Id = 2008, OwnerId = ownerZId, Title = "Smouha Park Residence", Description = "Spacious residence overlooking a calm residential area", Type = PropertyType.House, IsShared = false, MaxOccupants = 5, Bedrooms = 3, Beds = 4, Bathrooms = 2, SquareMeters = 172, Views = 10, Price = 11500m, RentalUnit = RentalUnit.Monthly, Address = "27 Fawzy Moaz Street", City = "Smouha", State = Governorate.AlexandriaGovernorate.ToString(), ZipCode = "21646", Latitude = 31.2150, Longitude = 29.9553, IsActive = true, Status = PropertyStatus.Verified, CreatedAt = new DateTime(2026, 5, 8, 0, 0, 0, DateTimeKind.Utc), ProofOfOwnership = "/images/documents/property2008-POO.jpg" },
                ...
                new Property { Id = 2013, OwnerId = ownerXId, Title = "Belbeis Courtyard House", Description = "Traditional house with a private courtyard and storage", Type = PropertyType.House, IsShared = false, MaxOccupants = 5, Bedrooms = 3, Beds = 4, Bathrooms = 2, SquareMeters = 180, Views = 3, Price = 6900m, RentalUnit = RentalUnit.Monthly, Address = "19 Saad Zaghloul Street", City = "Belbeis", State = Governorate.SharkiaGovernorate.ToString(), ZipCode = "44621", Latitude = 30.4204, Longitude = 31.5622, IsActive = true, Status = PropertyStatus.Verified, CreatedAt = new DateTime(2026, 5, 13, 0, 0, 0, DateTimeKind.Utc), ProofOfOwnership = "/images/documents/property2013-POO.jpg" },
                ...
                // Damietta
                new Property { Id = 2016, OwnerId = ownerZId, Title = "Damietta Port Apartment", Description = "Modern apartment near the city center and port", Type = PropertyType.Apartment, IsShared = false, MaxOccupants = 3, Bedrooms = 2, Beds = 2, Bathrooms = 1, SquareMeters = 108, Views = 7, Price = 6100m, RentalUnit = RentalUnit.Monthly, Address = "18 El Galaa Street", City = "Damietta", State = Governorate.DamiettaGovernorate.ToString(), ZipCode = "34511", Latitude = 31.4165, Longitude = 31.8133, IsActive = true, Status = PropertyStatus.Verified, CreatedAt = new DateTime(2026, 5, 16, 0, 0, 0, DateTimeKind.Utc), ProofOfOwnership = "/images/documents/property2016-POO.jpg" },
