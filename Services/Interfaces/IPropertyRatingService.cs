...
namespace MARN_API.Services.Interfaces
{
    public interface IPropertyRatingService
    {
        ...
        Task<ServiceResult<PropertyRating>> CreateAsync(long propertyId, Guid userId, CreatePropertyRatingDto dto);
        Task<ServiceResult<PropertyRating>> UpdateAsync(long propertyId, Guid userId, UpdatePropertyRatingDto dto);
